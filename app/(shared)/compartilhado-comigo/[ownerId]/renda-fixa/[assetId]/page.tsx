...
export default async function SharedAtivoRendaFixaPage({
  params,
}: {
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>{pos.maturity_date ? formatDate(pos.maturity_date) : "-"}</CardTitle>
          </CardHeader>
        </Card>
        <Card>
          <CardHeader>
              ...
              <TableBody>
                {transactions.map((tx) => (
                  <TableRow key={tx.id}>
                    ...
                    <TableCell>
                      <Badge variant="secondary">{TX_TYPE_LABELS[tx.tx_type]}</Badge>
                    </TableCell>
