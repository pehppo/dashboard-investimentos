...
export default async function SharedDashboardPage({
  ...
  const { data } = await supabase.from("positions").select("*").eq("user_id", ownerId);
            ...
            <div className="space-y-4">
              {Object.entries(porClasse)
                ...
                .map(([classe, valor]) => {
                  ...
                  return (
                    <div key={classe} className="space-y-1.5">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {rvPositions.length > 0 ? (
          <ClassSummaryCard
            ...
            href={`/compartilhado-comigo/${ownerId}/renda-variavel`}
        ...
        {rfPositions.length > 0 ? (
          <ClassSummaryCard
            title="Renda Fixa"
            href={`/compartilhado-comigo/${ownerId}/renda-fixa`}
