...
export default async function RendaFixaPage() {
  ...
  // quando a estimativa não está disponível (sem vencimento definido), mantém o valor investido
  const totalEstimado = rows.reduce(
    (sum, r) => sum + (r.estimated ?? r.net_invested),
    0,
  );
